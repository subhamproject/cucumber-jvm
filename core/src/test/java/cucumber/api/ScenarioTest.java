...
public class ScenarioTest {
    ...
    private Scenario scenario(String uri) {
        return new ScenarioImpl(mock(EventBus.class), mock(TestCase.class), pickle(uri, location()));
    }

    private Scenario scenario(String uri, Location... locations) {
        return new ScenarioImpl(mock(EventBus.class), mock(TestCase.class), pickle(uri, locations));
    }

    private Scenario scenario(Location... locations) {
        return new ScenarioImpl(mock(EventBus.class), mock(TestCase.class), pickle(locations));
    }
